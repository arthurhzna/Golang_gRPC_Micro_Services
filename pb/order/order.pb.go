...
const file_order_order_proto_rawDesc = "" +
	...
	"pagination\x125\n" +
	"\x04data\x18\x03 \x03(\v2!.order.ListOrderAdminResponseItemR\x04data2\xa3\x01\n" +
	"\fOrderService\x12D\n" +
	"\vCreateOrder\x12\x19.order.CreateOrderRequest\x1a\x1a.order.CreateOrderResponse\x12M\n" +
	"\x0eListOrderAdmin\x12\x1c.order.ListOrderAdminRequest\x1a\x1d.order.ListOrderAdminResponseB,Z*github.com/arthurhzna/Golang_gRPC/pb/orderb\x06proto3"
